...
library(units)
reg$surface_km <- set_units(x= reg$surface, value = km^2)

# Calcul de la densité de population par km2 en 2024
reg$dens_pop24 <- reg$P2024/reg$surface_km


# Diagramme de distribution
hist(reg$dens_pop24)
mf_distr(reg$dens_pop24)
...
# Suppression de l'unité associée aux valeurs du vecteur
...
# Représentation de la série statistique en log()
